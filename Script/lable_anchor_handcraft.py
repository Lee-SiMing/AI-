...
# ★ 每次运行前修改以下配置 ★
# ==============================
INPUT_JSON = "E:/music-traing-data/json/f_anchor.json"   # 包含所有文件 bpm/key 的 JSON
OUTPUT_JSON = "E:/music-traing-data/json/u_anchor.json"   # 最终累积输出文件
CHECKPOINT_PATH = r"C:/Users/Administrator/panns_data/Cnn14_mAP=0.431.pth"

TARGET_FOLDER = r"E:\music-traing-data\anchor\yangqin"       # 本次要处理的子文件夹
